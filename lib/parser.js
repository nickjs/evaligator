...
function calculateLineNumber(aSource, aLocation)
{
    return aSource.substr(0, aLocation).split(/[\n|\r]/).length - 1;
}
...
function SyntaxNode(/*String*/ aName, /*String*/ aSource, /*Number*/ aLocation, /*Number*/ aLength, /*String*/anErrorMessage)
{
    ...
    this.lineNumber = calculateLineNumber(aSource, aLocation);
    this.endLineNumber = calculateLineNumber(aSource, aLocation + aLength);
    this.children = [];
